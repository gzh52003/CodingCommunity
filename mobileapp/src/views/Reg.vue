<template>
  <div class="reg">
    ...
    <van-form @submit="onSubmit">
      ...
      <van-field v-model="ma" type="text" name="ma" label="短信验证码" placeholder="手机号"
    ...
    <p class="readme">
      ...
      <a href="https://terms.alicdn.com/legal-agreement/terms/suit_bu1_taobao/suit_bu1_taobao201703241622_61002.html"
